    ...
    <body>
        <div id="general">
            ...
            <?php
                ...
                {
                    // Consulta para saber que jesuita es
                    $consulta = "SELECT jesuita, lugar FROM maquina WHERE ip='".$_SESSION["ip"]."'";
                    ...
                    if($objeto->comprobar()>0)
                    {
                        ...
                        {
                            echo '<p>Aun no tienes un jesuita asignado</p>';
                        }
                        else
                        {
                            ...
                            else // Cuando se le da el boton enviar.
                            {
                                ...
                                else // En caso de haber selecionado otro lugar.
                                {
                                    ...
                                    if ($objeto->comprobarFila()>0)
                                    {
                                        ...
                                        if($fila["jesuita"] == $_SESSION["jesuita"] OR $lugar == $_SESSION["lugar"])
                                        {
