                ...
                else
                {
                    ...
                    if(!isset($_POST["Modificar"]))
                    {
                        ...
                        if(empty($lugarmaquina))
                        {
                            ...
                            // Consulta muestra los lugares no asignados
                            $consulta = "SELECT lugar.idLugar, lugar.nombreLugar FROM lugar LEFT JOIN maquina ON lugar.idLugar = maquina.lugar WHERE maquina.lugar IS NULL OR maquina.lugar = '$jesuitamaquina';";
                            //print_r($consulta);
                            $objeto->realizarConsultas($consulta);
                        ...
                        {
                            // Consulta para sacar el primer lugar de la maquina.
                            $consulta = "SELECT idJesuita, nombreJesuita FROM jesuita WHERE idJesuita= '".$lugarmaquina."';";
                            //print_r($consulta);
                            $objeto->realizarConsultas($consulta);
