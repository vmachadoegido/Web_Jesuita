                                    ...
                                    else
                                    {
                                        if($_GET["opcionusuario"]=="modificar")
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                {
                                                    // Entra cuando esta rellena la $_POST["ip"]

                                                    // ipnw, password, idLugar, idJesuita
                                                    // Relleno la Ip nueva

                                                    if((!empty($_POST["ipnew"])) and (!empty($_POST["password"])) and (!empty($_POST["lugar"])) and (!empty($_POST["jesuita"])))
                                                    {
